...
class ListCancerAdapter  (private val listArticles: ArrayList<Articles>) : RecyclerView.Adapter<ListCancerAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_row_cancer, parent, false)
